...
- ### Користувач:
    ...
    ##### 3. **Отримання контактних данних** (`GET`): Отримуємо контактні дані користувача `/user/me/`
    ...
    - **500** - Невідома помилка сервера
    ##### 4. **Змінення контактних данних** (`PUT`): Змінюємо контактні дані користувача `/user/me/`
    ...
    - **403** - Немає доступу без авторизації.
    - **500** - Невідома помилка сервера
    ##### 5. **Отримання моїх замовлення** (`GET`): Отримання поточних замовлень `/user/orders/`
    ...
    - **403** - Немає доступу без авторизації.
    - **500** - Невідома помилка сервера
    ##### 6. **Скасування моїх замовлення** (`DELETE`): Скасування поточного замовлення `/user/orders/:id`
    - **200** - Замовлення скасовано (видалено).
    - **400** - Передано неправильний формат даних.
    - **403** - Немає доступу без авторизації.
    - **500** - Невідома помилка сервера.
    ##### 7. **Отримання моїх адрес доставки** (`GET`): Отримання адрес доставки `/user/addresses/`
    ...
    - **403** - Немає доступу без авторизації.
    - **500** - Невідома помилка сервера
    ##### 8. **Додавання адресу доставки** (`POST`): Додавання адресу доставки `/user/addresses/`
    ...
    - **403** - Немає доступу без авторизації.
    - **500** - Невідома помилка сервера
    ##### 9. **Змінення адресу доставки** (`PUT`): Змінення адресу доставки `/user/addresses/:id`
